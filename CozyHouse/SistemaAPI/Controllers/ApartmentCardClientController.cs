...
namespace SistemaAPI.Controllers
{
    ...
    public class ApartmentCardClientController : ControllerBase
    {
        ...
        private readonly ILogger<ApartmentCardClientController> _logger;

        public ApartmentCardClientController(ContextDataBase context, ILogger<ApartmentCardClientController> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> GetUserApartments(int userId)
        {
            try
            {
                ...
                {
                    _logger.LogInformation("No se encontraron apartamentos para el usuario con id {UserId}", userId);
